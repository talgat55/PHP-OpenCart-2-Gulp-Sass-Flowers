            ...
            <?php if (!$cart_empty) { ?>
                ...
                <div class="simplecheckout-button-block buttons" id="buttons">
                    <div class="simplecheckout-button-right">
                        ...
                        <?php } ?>
                        <a class="button link__alt create-order" <?php echo $block_order ? 'disabled' : '' ?> data-onclick="createOrder" id="simplecheckout_button_confirm"><span><?php echo $button_order; ?></span></a>
                    </div>
            ...
            <?php } else { ?>
                ...
                <?php if (!$popup && !$as_module) { ?>
                    <div class="simplecheckout-button-block buttons">
                        ...
                        <div class="simplecheckout-button-right right  "><a href="<?php echo $continue; ?>" class="button link__alt"><span><?php echo $button_continue; ?></span></a></div>
                    </div>
                <?php } ?>
            <?php } ?>
        </div>
