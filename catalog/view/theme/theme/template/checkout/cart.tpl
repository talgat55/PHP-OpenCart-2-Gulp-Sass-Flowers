...
<div class="container">
    ...
    <div class="row"><?php echo $column_left; ?>
        ...
        <?php } else { ?>
            <?php $class = 'col-sm-12'; ?>
        <?php } ?>
        <div id="content" class="<?php echo $class; ?> page-cat"><?php echo $content_top; ?>
            <h1 class="main-title">
            ...
            <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
                <div class="table-responsive">
                    ...
                    <button type="submit" data-toggle="tooltip" title="<?php echo $button_update; ?>"
                            class="btn  refresh-cart"><i class="fas fa-sync"></i></button>
                    <button type="button" data-toggle="tooltip" title="<?php echo $button_remove; ?>"
                            class="btn btn-danger  delete-cart" onclick="cart.remove('<?php echo $product['cart_id']; ?>');"><i
            ...
            <div class="row justify-content-end">
                <div class="col-md-4  col-sm-12  mb-4 d-md-flex justify-content-end">
