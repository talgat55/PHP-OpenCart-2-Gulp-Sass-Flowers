                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                                ...
                                <form>
                                    <div class="row">
                                        ...
                                        <div class="second col-lg-4 col-md-12">
                                            <div id="slider" data-min="<?php echo $minPrice; ?>"
                                            ...
                                            <div id="clear-filter" class="text-right">
                                                <a href="#" class="clear-filter">
                                                    <img src="/catalog/view/theme/theme/images/main/close.png"
                                                         alt="иконка"/>
                                                    <span>
                                                    Сбросить фильтр
                                                </span>
                            ...
                            <div class="wrapper-product-list w-100">
                                <ul class="product-layout product-list  product-list-filtered row">
